...
% yout,ycal, stats available            
    ...
    if  evalin('base','mcr_als.alsOptions.opt.gr')=='y'
        ...
        evalin('base','mcr_als.cache.als_end=als_end;');
        assignin('base','cx_plot',conc);
        evalin('base','mcr_als.cache.cx_plot=cx_plot;');
        assignin('base','sx_plot',abss);
        evalin('base','mcr_als.cache.sx_plot=sx_plot;');
        assignin('base','niter_plot',niter);
        evalin('base','mcr_als.cache.niter_plot=niter_plot;');
        assignin('base','change_plot',change);
        evalin('base','mcr_als.cache.change_plot=change_plot;');
        assignin('base','sstd_plot',sstd);
        evalin('base','mcr_als.cache.sstd_plot=sstd_plot;');
    ...
    if abs(change) < evalin('base','mcr_als.alsOptions.opt.tolsigma')
        ...
        evalin('base','mcr_als.cache.copt_xxx=copt_xxx;');
        assignin('base','sopt_xxx',sopt);
        evalin('base','mcr_als.cache.sopt_xxx=sopt_xxx;');
        assignin('base','sdopt_xxx',sdopt);
        evalin('base','mcr_als.cache.sdopt_xxx=sdopt_xxx;');
        assignin('base','r2opt_xxx',r2opt);
        evalin('base','mcr_als.cache.r2opt_xxx=r2opt_xxx;');
        assignin('base','rtopt_xxx',rtopt);
        evalin('base','mcr_als.cache.rtopt_xxx=rtopt_xxx;');
        assignin('base','itopt_xxx',itopt);
        evalin('base','mcr_als.cache.itopt_xxx=itopt_xxx;');
        assignin('base','change_xxx',sigman); % for std dev res vs exp
        evalin('base','mcr_als.cache.change_xxx=change_xxx;');
